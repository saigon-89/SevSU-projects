...
v0 = [0, 0, 0, 0, 0, 0]';
eta_set = [5 -5 0 0 pi/4 pi/6]'; % уставка для единичной обратной связи
t_end = 60; dt = 0.01;
[t,Y] = ode45(@(t,y)odefcn(t,y,M,C,D,g,J,eta_set,'fb'), 0:dt:t_end, [eta0; v0]);
...
hold on
plot3(eta_set(1), eta_set(2), eta_set(3), 'rO') 
...
eta0 = [0, 0, 0, 0, 0, 0]'; 
v0 = [0, 0, 0, 0, 0, 0]';
thruster_mask = [1, 1, 1, 1, 1, 1]';
tau = @(code)tau_c(code) * thruster_mask;
